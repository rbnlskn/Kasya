            ...
            <div className="grid grid-cols-4 gap-4">
              {localCategories.map((cat, index) => (
                ...
                >
                  ...
                  <div
                    className={`w-12 h-12 flex items-center justify-center text-xl mb-2 relative shadow-sm rounded-lg drop-shadow-sm ${!cat.color.startsWith('#') ? cat.color : ''}`}
            ...
            <form onSubmit={handleSave} className="space-y-6">
              <div className="flex justify-center">
                ...
                <button
                  ...
                  className={`w-24 h-24 rounded-lg flex items-center justify-center text-5xl shadow-sm transition-transform hover:scale-105 active:scale-95 drop-shadow-sm ${!editingCategory.color.startsWith('#') ? editingCategory.color : ''}`}

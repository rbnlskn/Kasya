...
const BudgetDetailView: React.FC<BudgetDetailViewProps> = ({ budget, transactions, categories, wallets, onBack, onEdit, onTransactionClick, currencySymbol, isExiting, spending }) => {

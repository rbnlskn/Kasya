...
const CommitmentCard: React.FC<CommitmentCardProps> = ({
  ...
  return (
    <div
      ...
      className="w-full bg-white rounded-3xl p-4 shadow-sm border border-slate-100 cursor-pointer active:scale-[0.99] transition-transform duration-200 flex flex-col justify-between h-[172px]"
    >
      {/* HEADER */}

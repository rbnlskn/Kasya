...
def verify_commitments(page):
    ...
    page.wait_for_selector('div[data-testid="commitments-button"]', state="visible")

    # Navigate to Commitments
    page.click('div[data-testid="commitments-button"]')

    # Wait for view to load
    page.wait_for_selector('div[data-testid="commitments-view"]', state="visible")
    ...
    # Screenshot 2: View All Credit Cards (to check shadow on items)
    page.click("text=Credit Cards") # Or click "VIEW ALL" if text matches
    page.wait_for_timeout(500)
    # Actually clicking "VIEW ALL" next to Credit Cards
    # page.click("text=VIEW ALL >> nth=0") # might be tricky.
    # Let's rely on dashboard screenshot for now.
...
if __name__ == "__main__":
    with sync_playwright() as p:
        ...
        # Use a mobile viewport to match user context
